...
Public Class Soaljawaban_SBMPTN
    ...
    Public Function SubmitAnswerJawaban(idExecute As Integer, jawaban As String)
        Dim baseUrl As String = "https://api.permatamall.com/api/v2/belajar/home/ptn/latihan-soal/answer"
    ...
    Public Function SubmitFinishSelesai(idExamp As Integer) As FinishSoalResponse
        ...
        Dim baseUrl As String = "https://api.permatamall.com/api/v2/belajar/home/ptn/latihan-soal/finish"
        Dim request = New With
       {
            .id_examp = idExamp
        }
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Prestasi_SBMPTN.Label2.Text = Me.Label2.Text
        Prestasi_SBMPTN.IdContent = IdContent
        Prestasi_SBMPTN.IdPelanggan = IdPelanggan
        Prestasi_SBMPTN.jawaban_benar.Text = finish.Data.Betul
        Prestasi_SBMPTN.jawaban_kosong.Text = finish.Data.Blank
        Prestasi_SBMPTN.jawaban_salah.Text = finish.Data.Salah
        Prestasi_SBMPTN.Show()
    ...
    End Sub
    Private Sub Soaljawaban_SBMPTN_Load(sender As Object, e As EventArgs) Handles MyBase.Load
